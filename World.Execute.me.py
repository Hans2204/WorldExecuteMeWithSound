...
while Complite == False:
    ...
    World.slow_print(style.RED+"Lay down your pieces"+style.RESET,0.03 )
    World.layDown()
    World.slow_print(style.RED+"And let's begin"+style.RESET,0.03 )
    World.slow_print(style.GREEN+" OBJECT_CREATION"+style.RESET,0.03 )
    data["objectCreation"] = True
    print("\n>>> object Creation : "+str(data["objectCreation"]))
    time.sleep(0.5)
    World.slow_print(style.GREEN+"\n Fill in my data"+style.RESET,0.05 )
    World.slow_print(style.GREEN+" PARAMETER"+style.RESET,0.005 )
    World.INITIALIZATION()
    data["Parameter"] = "100%"
    time.sleep(0.3)
    World.slow_print(style.RED+"\n Set up a new World"+style.RESET,0.05  )
    ...
    if data["objectCreation"] == True and data["Parameter"] == "100%" and data["NewWorld"] == "setup done":
        World.slow_print(style.RED+"\n And let's begin the "+style.RESET,0.04 )
        time.sleep(0.1)
        ...
        if data["setOfPoint"] != "":
            ...
            time.sleep(0.02)
            World.slow_print(style.YELLOW+" DIMENSION"+style.RESET,0.02 )
            World.GiveDimension(data["im"])
            time.sleep(0.3)
            World.slow_print(style.RED+"\n If I'm a "+style.RESET,0.03 )
            ...
            if data["Circel"] == len(data["setOfPoint"]):
                ...
                World.slow_print(style.RED+" my"+style.RESET,0.04 )
                time.sleep(0.2)
                World.slow_print(style.YELLOW+" CIRCUMFERENCE"+style.RESET,0.02 )
                ...
                if len(data["sineWave"]) == 11:
                    ...
                    time.sleep(0.3)
                    World.prettyPrint(data)
                    World.slow_print(style.RED+"\n Then you can sit "+style.RESET,0.03 )
                    ...
                    time.sleep(0.3)
                    World.slow_print(style.RED+"\n If I approach  "+style.RESET,0.03 )
                    ...
                    if data["im"] == "INFINITY":
                        ...
                        data["currenct1"] = x
                        time.sleep(0.3)
                        World.slow_print(style.GREEN+" ----------- > DC"+style.RESET,0.03 )
                        ...
                        time.sleep(0.6)
                        World.BlindMYVision()
                        World.slow_print(style.GREEN+"\nM  Y       V  I  S  I  O  N"+style.RESET,0.03 )
                        World.slow_print(style.RED+"\nSo dizzy, "+style.RESET,0.05 )
                        time.sleep(0.05)
                        World.slow_print(style.RED+"So dizzy"+style.RESET,0.04 )
                        World.slow_print(style.GREEN+"\nOh..., we can travel"+style.RESET,0.03 )
                        time.sleep(0.5)
                        start = time.time()
                        ...
                        World.slow_print(style.MAGENTA+"give you all "+style.RESET,0.05 )
                        World.slow_print(style.YELLOW+" THE SIMULATIONS"+style.RESET,0.05 )
                        ...
                        World.slow_print(style.MAGENTA+"be your only "+style.RESET,0.05 )
                        World.slow_print(style.YELLOW+" SATISFACTION"+style.RESET,0.05 )
                        if data["simulation"] == "ᛞᚫᛉᚵᛒᛍᛣᛤᛄ":
                            print(style.RED+"\n>>>SYSTEM SAYS : SO SAD :'("+style.RESET)
                        time.sleep(0.4)
                        World.slow_print(style.GREEN+"\nIf I can make you happy"+style.RESET,0.03)
                        time.sleep(0.3)
                        World.slow_print(style.GREEN+" Then I'll run the "+style.RESET,0.03)
                        time.sleep(0.3)
                        World.slow_print(style.YELLOW+" E  X  E  C  U  T  I  O  N "+style.RESET,0.003)
                        ...
                        print("\n\n")
                        time.sleep(0.3)
                        World.slow_print(style.RED+"\nIn this strange, "+style.RESET,0.03 )
                        World.slow_print(style.RED+"  strange"+style.RESET,0.03 )
                        World.slow_print(style.YELLOW+" SIMULATIONS"+style.RESET,0.03 )
                        time.sleep(0.4)
                        World.slow_print(style.GREEN+"\nIf I'm an eggplant "+style.RESET,0.04 )
                        time.sleep(0.03)
                        World.slow_print(style.GREEN+"Then I will give you my "+style.RESET,0.03)
                        World.slow_print(style.YELLOW+"NUTRIENTS"+style.RESET,0.03 )
                        data["you"] = []
                        ...
                        time.sleep(0.4)
                        World.slow_print(style.GREEN+"\nIf I'm an tomato "+style.RESET,0.05 )
                        time.sleep(0.03)
                        World.slow_print(style.GREEN+"Then I will give you "+style.RESET,0.03)
                        World.slow_print(style.YELLOW+"ANTIOXIDANTS"+style.RESET,0.03 )
                        ...
                        time.sleep(0.4)
                        World.slow_print(style.GREEN+"\nIf I'm a tabby cat "+style.RESET,0.05)
                        time.sleep(0.03)
                        World.slow_print(style.GREEN+"Then I will purr for your "+style.RESET,0.03)
                        World.slow_print(style.YELLOW+"ENJOYMENT"+style.RESET,0.03)
                        data["me"] = random.choice(["tomato","tomato","tomato","ikan hiu makan tomat"])
                        if data["me"] == "tomato":
                            print("\n"+World.GET_ENJOYMENT())
                        ...
                        time.sleep(0.4)
                        World.slow_print(style.GREEN+"\nIf I'm the only god "+style.RESET,0.05)
                        time.sleep(0.03)
                        World.slow_print(style.GREEN+"Then your the proof of my "+style.RESET,0.05)
                        World.slow_print(style.YELLOW+"EXISTENCE"+style.RESET,0.05)
                        ...
                        print("\n\n")
                        time.sleep(0.05)
                        World.slow_print(style.RED+"Switch my "+style.RESET,0.05 )
                        World.slow_print(style.GREEN+"gender"+style.RESET,0.03)
                        time.sleep(0.6)
                        World.slow_print(style.GREEN+"\nTo ----------- > F"+style.RESET,0.03 )
                        data["you"].append("GANDER ::: FEMALE")
                        print(style.RED+"\n>>>SYSTEM SAYS : SUCCESS SET TO FEMALE !!"+style.RESET)
                        time.sleep(0.3)
                        World.slow_print(style.GREEN+" ----------- > M"+style.RESET,0.03)
                        data["you"].remove("GANDER ::: FEMALE")
                        data["you"].append("GANDER ::: MALE")
                        print(style.RED+"\n>>>SYSTEM SAYS : SUCCESS SWITCH TO MALE !!"+style.RESET)
                        time.sleep(0.05)
                        World.slow_print(style.RED+"And then do "+style.RESET,0.05 )
                        World.slow_print(style.GREEN+"whatever"+style.RESET,0.03 )
                        World.slow_print(style.GREEN+"\nTo ----------- > AM"+style.RESET,0.03 )
                        x = World.GetTimeNow()
                        timess = str(x)
                        data["you"].append(f"TIME ::: {timess} AM")
                        print(style.RED+f"\n>>>SYSTEM SAYS : {x} AM"+style.RESET)
                        data["you"].remove(f"TIME ::: {timess} AM")
                        World.slow_print(style.GREEN+"\nTo ----------- > PM"+style.RESET,0.03 )
                        x = World.GetTimeNow()
                        tmiexx = str(x)
                        print(style.RED+f"\n>>>SYSTEM SAYS : {tmiexx} PM"+style.RESET)
                        data["you"].append(f"TIME ::: {tmiexx} PM")
                        time.sleep(0.05)
                        World.slow_print(style.RED+"I will switch "+style.RESET,0.05 )
                        World.slow_print(style.GREEN+"my role"+style.RESET,0.03 )
                        World.slow_print(style.GREEN+"\nTo ----------- > S"+style.RESET,0.03 )
                        data["you"].append(f"ROLE ::: S")
                        print(style.RED+f"\n>>>SYSTEM SAYS : SET ROLE TO 'S'"+style.RESET)
                        World.slow_print(style.GREEN+"\nTo ----------- > M"+style.RESET,0.03 )
                        print(style.RED+f"\n>>>SYSTEM SAYS : CHANGE ROLE TO 'M'"+style.RESET)
                        data["you"].remove(f"ROLE ::: S")
                        data["you"].append(f"ROLE ::: M")
                        time.sleep(0.06)
                        World.slow_print(style.RED+"\nSo we can enter "+style.RESET,0.09 )
                        World.slow_print(style.GREEN+"the trance,"+style.RESET,0.05 )
                        World.slow_print(style.GREEN+"the trance"+style.RESET,0.05 )
                        time.sleep(0.6)
                        ...
                        time.sleep(1)
                        World.slow_print(style.MAGENTA+"IF I CAN "+style.RESET,0)
                        World.slow_print(style.MAGENTA+" feel your"+style.RESET,0.05)
                        World.slow_print(style.YELLOW+" VIBRATIONS"+style.RESET,0.03)
                        time.sleep(1)
                        print(style.BLUE+"\nThen I can")
                        time.sleep(1)
                        World.slow_print(style.BLUE+"Then I can "+style.RESET,0)
                        World.slow_print(style.BLUE+" finally be"+style.RESET,0.09)
                        World.slow_print(style.BOLD+" C O M P L E T I O N"+style.RESET,0.04)
                        Complite = True
...
World.slow_print(style.BOLD+"\n You have left me in"+style.RESET,0.04)
World.slow_print(style.YELLOW+" ISOLATION"+style.RESET,0.04)
...
World.slow_print(style.YELLOW+" FRAGMENTS"+style.RESET,0.03)
World.slow_print(style.GREEN+"\nThen maybe"+style.RESET,0.03)
World.slow_print(style.GREEN+"\nThen maybe,  "+style.RESET,0.03)
World.slow_print(style.GREEN+" you won't leave me so  "+style.RESET,0.03)
...
World.slow_print(style.YELLOW+" # You have made some  !!"+style.RESET,0.07)
try:
    x = [1,2,3]
    print(x[99])
except:
...
time.sleep(0.1)
World.slow_print(style.RED+" OVE"+style.RESET,0)
me = "Code by Rehan Roti Roma, Music by Mili"
World.Execute(me)
